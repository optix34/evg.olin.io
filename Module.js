 ...
 * Чекбоксы отображаются с подписью сверху («точно под своим названием»).
...
Ext.define('Store.sensor_dashboard.Module', {
    ...
    loadConfigForVehicle: function (vehid, vehicleName) {
        ...
        Ext.each(me.sensors, function (sensor) {
            ...
            // Чекбокс с подписью сверху
            var checkbox = Ext.create('Ext.form.field.Checkbox', {
                fieldLabel: sensor.label,
                labelAlign: 'top',          // подпись сверху – «точно под своим названием»
                itemId: sensor.name,
                checked: checked,
                disabled: false,
    ...
    renderChart: function (categories, seriesData, totalVehicleCount) {
        ...
        me.chart = Highcharts.chart(el, {
            ...
            xAxis: {
                ...
                title: { text: 'Датчики', style: { fontSize: '13px' } },
                labels: { rotation: -45, style: { fontSize: '12px' } }
            },
            yAxis: {
                title: { text: 'Количество ТС', style: { fontSize: '13px' } },
                min: 0,
                allowDecimals: false
            },
            tooltip: {
